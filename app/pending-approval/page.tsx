...
export default async function PendingApprovalPage() {
  ...
  const userEmail = user?.emailAddresses[0]?.emailAddress || "your registered email";
      ...
      <div className="max-w-lg w-full bg-slate-900/80 border border-slate-800/80 rounded-3xl p-8 text-center space-y-6 shadow-2xl backdrop-blur-sm">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-400 leading-relaxed max-w-sm mx-auto">
            Your registration request for <span className="text-slate-200 font-medium">{userEmail}</span> has been received and is currently being reviewed by an administrator.
          </p>
        </div>
        ...
        <div className="bg-slate-950/60 border border-slate-800/80 rounded-2xl p-4 text-left space-y-3">
          ...
          <ul className="text-xs text-slate-300 space-y-2.5">
            <li className="flex items-start gap-2.5">
              <span className="flex-shrink-0 w-5 h-5 rounded-full bg-slate-800 text-slate-300 flex items-center justify-center text-[10px] font-bold">1</span>
              <span>An admin verifies your regional details and grants access.</span>
            </li>
            <li className="flex items-start gap-2.5">
              <span className="flex-shrink-0 w-5 h-5 rounded-full bg-slate-800 text-slate-300 flex items-center justify-center text-[10px] font-bold">2</span>
              <span>You will receive your unique **AGRI-ID** and **Security PIN** in your email!.</span>
            </li>
            <li className="flex items-start gap-2.5">
              <span className="flex-shrink-0 w-5 h-5 rounded-full bg-slate-800 text-slate-300 flex items-center justify-center text-[10px] font-bold">3</span>
              <span>Use your ID and PIN on the portal access screen to enter the dashboard.</span>
            </li>
          </ul>
        </div>
