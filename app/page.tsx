...
export default function Home() {
  return (
    /* Added pt-28 to push the content down safely below the fixed navbar */
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center pt-28">
